...
# plotting the values
ax = plt.axes()
ax.scatter(bob_t, bob_theta, c=gradient_of_colours(initial_colour, final_colour, len(bob_positions)))
ax.set_xlabel('t [s]')
ax.set_ylabel('theta [rad]')
ax.set_title('t vs. theta plot of a Simple Pendulum using Euler-Cromer')
'''plt.xlim(-10, 10)
plt.ylim(-15, 5)'''
plt.show()
